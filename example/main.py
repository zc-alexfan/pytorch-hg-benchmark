...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', metavar='DATASET', default='mpii',
                        ...
                        help='Datasets: ' +
                            ' | '.join(dataset_names) +
                            ' (default: mpii)')
    parser.add_argument('--image-path', default='/home/alex/Desktop/pytorch-pose/data/mpii/images', type=str,
                        help='path to images')
    parser.add_argument('--anno-path', default='/home/alex/Desktop/pytorch-pose/data/mpii/mpii_annotations.json', type=str,
